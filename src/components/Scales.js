...
export default class Scales extends React.Component {
    ...
    renderMajorScales = () => {
        ...
        return majorScales.map((scale, index) => {
            ...
            return <Link to={`scales/${url}`} className='scaleLink' style={{color: "black"}} key={index}><li className="scaleLi" style={{listStyleType: "none", margin: "5px", borderBottom: "1px solid black"}}>{scale.scale_name}</li></Link>
        })
    }
    ...
    renderMajorPentatonicScales = () => {
        ...
        return majorPentatonicScales.map((scale, index) => {
            ...
            return <Link to={`scales/${url}`} className='scaleLink' style={{color: "black"}} key={index}><li className="scaleLi" style={{listStyleType: "none", marginTop: "5px", marginBottom: "5px", borderBottom: "1px solid black"}}>{scale.scale_name}</li></Link>
        })
    }
